...
import 'notifiers/query_notifier.dart';
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    ref.read(queryNotifierProvider.notifier).queryPineconeIndex(query: queryTextCtrl.text);
                  },
              ...
              const SizedBox(height: 20),
              if (queryState.state == QueryEnum.loading) const LinearProgressIndicator(),
